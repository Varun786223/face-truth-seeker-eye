  ...
  const demos = [
    {
      ...
      result: { score: 87, status: "suspicious", confidence: "high" }
    },
    {
      id: "voice-clone",
      ...
      result: { score: 23, status: "authentic", confidence: "medium" }
    },
    {
      id: "document",
      ...
      result: { score: 94, status: "ai-generated", confidence: "high" }
    }
  ];
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div className="relative">
                    <img
                      src={demos.find(d => d.id === activeDemo)?.image}
                      alt="Demo content"
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="w-full bg-muted rounded-full h-2">
                            <div 
                              ...
                              style={{ width: `${demos.find(d => d.id === activeDemo)?.result.score}%` }}
                            />
                          </div>
                        </div>
                      </div>
